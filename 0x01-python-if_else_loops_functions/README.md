...
[lists.h](./lists.h) | header file for the C program above having the node struct 
...
[102-magic_calculation.py](./102-magic_calculation.py) | Python function created from a bytecodec